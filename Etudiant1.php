            ...
            <div class="card-body"  >
                ...
                <div class="form-group col-9 ml-7">
                    ...
                    <span class="h6 font-weight-normal text-gray mb-3">stage: <br></span>
                        ...
                        <label for="exampleInputPassword1">Intitulé du sujet</label>
                        <div class="input-group mb-4">
                        ...
                        <label for="exampleInputPassword1">Les technologies utilisées</label>
                        <div class="input-group mb-4">

                            <input class="form-control" type="text" name="technologie"  id="exampleInputPassword1"   required="required">
                        
                        </div>
                        <label for="exampleInputPassword1">Le nom du binôme</label>
                        <div class="input-group mb-4">
                        ...
                        <label for="exampleInputPassword1">Le prénom du binôme</label>
                        <div class="input-group mb-4">
                    ...
                    <input style="margin-left: 45%;" class="btn btn-primary text-danger" name="envoyer"  type="submit" value="Mis à jour">
