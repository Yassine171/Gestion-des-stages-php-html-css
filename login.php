<?php
$id_tables=array("enseignant"=>"id_ens", "etudient"=>"num_apoge_etud", "admin"=>"id_admin");
...
if(isset($_POST['submit'])){
    if(isset($_POST['login']) && isset($_POST['pass'])){
        ...
        $sql='SELECT '.$id_tables[$profil].' FROM '.$profil.' WHERE email="'.$login.'" and mot_de_passe="'.$pass.'"';
        ...
        if($result!=False){
            ...
            {
                session_start();
                $_SESSION['id_'.$profil]=htmlspecialchars($row[$id_tables[$profil]]);
                echo $_SESSION['id_'.$profil];
                header("Location: ".$profil.".php");
            }else
            {
                echo "<script>";
                echo 'alert("Mot de passe ou email incorrect!");';
                echo "</script>";
            }
                            ...
                            <div class="card-body">
                                <form action="" method="post" class="mt-4">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputIcon3">Login</label>
                                        <div class="input-group mb-4">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><span class="fas fa-envelope"></span></span>
                                            </div>
                                            <input class="form-control" id="exampleInputIcon3" name="login" placeholder="Login" type="email" aria-label="email adress" required="required">
                                        </div>
                                    </div>
                                    <!-- End of Form -->
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-4">
                                                ...
                                                <input class="form-control" id="exampleInputPassword6" name="pass" placeholder="Mot de passe" type="password" aria-label="Password" required="required">
                                            </div>
                                        </div>
                                        <!-- End of Form -->
                                        
                                    <button type="submit" name="submit" class="btn btn-block btn-primary">Se connecter</button>
                                </form>
